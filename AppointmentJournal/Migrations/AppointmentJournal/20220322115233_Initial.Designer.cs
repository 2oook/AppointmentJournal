...
namespace AppointmentJournal.Migrations.AppointmentJournal
{
    ...
    [Migration("20220322115233_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppointmentJournal.AppReversedDatabase.Address", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AppointmentJournal.AppReversedDatabase.Appointment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AppointmentJournal.AppReversedDatabase.Service", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AppointmentJournal.AppReversedDatabase.ServicesCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AppointmentJournal.AppReversedDatabase.WorkDay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AppointmentJournal.AppReversedDatabase.WorkDaysTimeSpan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AppointmentJournal.AppReversedDatabase.Appointment", b =>
                {
                    b.HasOne("AppointmentJournal.AppReversedDatabase.Service", "Service")
                        .WithMany("Appointments")
                        .HasForeignKey("ServiceId")
                        .IsRequired()
                        .HasConstraintName("FK_Appointments_Services");

                    b.HasOne("AppointmentJournal.AppReversedDatabase.WorkDaysTimeSpan", "WorkDayTimeSpan")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("AppointmentJournal.AppReversedDatabase.Service", b =>
                {
                    b.HasOne("AppointmentJournal.AppReversedDatabase.ServicesCategory", "Category")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("AppointmentJournal.AppReversedDatabase.WorkDaysTimeSpan", b =>
                {
                    b.HasOne("AppointmentJournal.AppReversedDatabase.Address", "Address")
                    ...
                    b.HasOne("AppointmentJournal.AppReversedDatabase.WorkDay", "WorkDay")
                        .WithMany("WorkDaysTimeSpans")
